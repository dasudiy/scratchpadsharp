...
namespace ScratchpadSharp.Core.External.O2Html;
...
{
    private readonly HtmlSerializerOptions _defaultHtmlSerializerOptions = new();
    private readonly ConcurrentDictionary<Type, HtmlConverter?> _typeConverterCache = new();
    private readonly ConcurrentDictionary<Type, TypeCategory> _typeCategoryCache = new();
    private readonly ConcurrentDictionary<Type, PropertyInfo[]> _typePropertyCache = new();
    private readonly ConcurrentDictionary<Type, Type?> _collectionElementTypeCache = new();
    ...
    {
        SerializerOptions = serializerSettings ?? new HtmlSerializerOptions();
    ...
    private bool ShouldShortCircuit<T>(
        T obj,
        Type type,
